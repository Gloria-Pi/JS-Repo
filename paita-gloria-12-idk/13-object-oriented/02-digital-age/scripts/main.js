...
let mVideo = new MusicVideo("Another Brick in the Wall", 300, "Pink Floyd");
mVideo.play();                // You played "Another Brick in the Wall" by "Pink Floyd"
mVideo.watch(120);            // You watched 120 seconds of "Another Brick in the Wall"
mVideo.watch();               // You watched all 300 seconds of "Another Brick in the Wall"

let mVideo1 = new MusicVideo();
mVideo1.play();                // You played "Another Brick in the Wall" by "Pink Floyd"
mVideo1.watch(120);            // You watched 120 seconds of "Another Brick in the Wall"
mVideo1.watch();               // You watched all 300 seconds of "Another Brick in the Wall"
*/
...
let mv = new MusicVideo("Another Brick in the Wall", 300, "Pink Floyd");
mv.play();                // You played "Another Brick in the Wall" by "Pink Floyd"
mv.watch(120);            // You watched 120 seconds of "Another Brick in the Wall"
mv.watch();               // You watched all 300 seconds of "Another Brick in the Wall"
*/